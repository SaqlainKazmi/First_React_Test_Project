...
const Main = () => {
  return (
    <div id="main">
      <img
        className="w-full h-[850px] object-cover object-left scale-x-[-1]"
        src={Img}
        alt=""
      />
      ...
      <div className="w-full h-screen absolute top-0 left-0 bg-white/60">
        <div className="max-w-[700px] m-auto h-full w-full flex flex-col justify-center lg:items-start items-center">
          <h1 className="sm:text-5xl text-4xl ml-[10%] font-bold text-gray-800 ">
            This is React Web Page
          </h1>

          <h2 className="flex sm:text-3xl text-2xl ml-[12%] pt-4 text-gray-800">
            <TypeAnimation
              sequence={[
